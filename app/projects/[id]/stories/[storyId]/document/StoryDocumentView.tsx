...
interface StoryDocumentViewProps {
...
export function StoryDocumentView({ document, projectId, storyId, storyTitle }: StoryDocumentViewProps) {
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-start gap-4">
          ...
          <div>
            <p className="text-sm text-muted-foreground mb-1">HU: {storyTitle}</p>
        ...
        <div className="flex gap-2">
          ...
          <Link href={`/projects/${projectId}/stories/${storyId}/document/edit`}>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Esta accion no se puede deshacer. El documento &quot;{document.title}&quot; sera eliminado permanentemente.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
