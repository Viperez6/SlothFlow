...
import { TaskDocumentView } from './TaskDocumentView'

interface Props {
  params: { id: string; taskId: string }
}

export default async function TaskDocumentPage({ params }: Props) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-moss-50 via-earth-50 to-sloth-50">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
          ...
          <span>/</span>
          <span className="text-sloth-800 font-medium">Documento</span>
        </nav>
